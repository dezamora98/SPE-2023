...
# \\vboxsvr\real-pc\Trabajo\CUJAE\SPE\SPE-2023\examples\ex_0\system.mhs
# The software specification of the system is in file :
# \\vboxsvr\real-pc\Trabajo\CUJAE\SPE\SPE-2023\examples\ex_0\system.mss
...
test_program: $(CYG_TEST_OUTPUT) 

$(CYG_TEST_OUTPUT) : $(TEST_SOURCES) $(TEST_HEADERS) $(TEST_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/test_compiler.opt
	@mkdir -p $(TEST_OUTPUT_DIR) 
	$(TEST_CC) $(TEST_CC_OPT) $(TEST_SOURCES) -o $(CYG_TEST_OUTPUT) \
	$(TEST_OTHER_CC_FLAGS) $(TEST_INCLUDES) $(TEST_LIBPATH) \
	$(TEST_CFLAGS) $(TEST_LFLAGS) 
	$(TEST_CC_SIZE) $(CYG_TEST_OUTPUT) 
	@echo ""
