...
# Project:\\vboxsvr\real-pc\Trabajo\CUJAE\SPE\SPE-2023\examples\ex_1\system.xmp
#
...
TEST_OUTPUT = $(TEST_OUTPUT_DIR)/executable.elf
CYG_TEST_OUTPUT_DIR = test
CYG_TEST_OUTPUT = $(CYG_TEST_OUTPUT_DIR)/executable.elf
...
BRAMINIT_ELF_FILES =  $(CYG_TEST_OUTPUT) 
BRAMINIT_ELF_FILE_ARGS =   -pe microblaze_0 $(TEST_OUTPUT) 

ALL_USER_ELF_FILES = $(CYG_TEST_OUTPUT) 
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -sd implementation/ -s isim -X Z:/Trabajo/CUJAE/SPE/SPE-2023/examples/ex_1/
...
PROGRAMCLEAN_TARGETS = test_programclean 
...
TEST_CC = mb-gcc
TEST_CC_SIZE = mb-size
TEST_CC_OPT = -O0
TEST_CFLAGS = 
TEST_CC_SEARCH = # -B
TEST_LIBPATH = -L./microblaze_0/lib/ # -L
TEST_INCLUDES = -I./microblaze_0/include/ # -I
TEST_LFLAGS = # -l
TEST_LINKER_SCRIPT = 
TEST_LINKER_SCRIPT_FLAG = #-T $(TEST_LINKER_SCRIPT) 
TEST_CC_DEBUG_FLAG =  -g 
TEST_CC_PROFILE_FLAG = # -pg
TEST_CC_GLOBPTR_FLAG= # -mxl-gp-opt
TEST_MODE = executable
TEST_LIBG_OPT = -$(TEST_MODE) microblaze_0
TEST_CC_INFERRED_FLAGS= -mxl-soft-mul -mxl-barrel-shift -mxl-pattern-compare -mcpu=v8.00.b 
TEST_CC_START_ADDR_FLAG=  # -Wl,-defsym -Wl,_TEXT_START_ADDR=
TEST_CC_STACK_SIZE_FLAG=  # -Wl,-defsym -Wl,_STACK_SIZE=
TEST_CC_HEAP_SIZE_FLAG=  # -Wl,-defsym -Wl,_HEAP_SIZE=
TEST_OTHER_CC_FLAGS= $(TEST_CC_GLOBPTR_FLAG)  \
                  $(TEST_CC_START_ADDR_FLAG) $(TEST_CC_STACK_SIZE_FLAG) $(TEST_CC_HEAP_SIZE_FLAG)  \
                  $(TEST_CC_INFERRED_FLAGS)  \
                  $(TEST_LINKER_SCRIPT_FLAG) $(TEST_CC_DEBUG_FLAG) $(TEST_CC_PROFILE_FLAG) 
