...
# \\vboxsvr\real-pc\Trabajo\CUJAE\SPE\SPE-2023\examples\ex_3\system.mhs
# The software specification of the system is in file :
# \\vboxsvr\real-pc\Trabajo\CUJAE\SPE\SPE-2023\examples\ex_3\system.mss
...
ex_timer_program: $(CYG_EX_TIMER_OUTPUT) 

$(CYG_EX_TIMER_OUTPUT) : $(EX_TIMER_SOURCES) $(EX_TIMER_HEADERS) $(EX_TIMER_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/ex_timer_compiler.opt
	@mkdir -p $(EX_TIMER_OUTPUT_DIR) 
	$(EX_TIMER_CC) $(EX_TIMER_CC_OPT) $(EX_TIMER_SOURCES) -o $(CYG_EX_TIMER_OUTPUT) \
	$(EX_TIMER_OTHER_CC_FLAGS) $(EX_TIMER_INCLUDES) $(EX_TIMER_LIBPATH) \
	$(EX_TIMER_CFLAGS) $(EX_TIMER_LFLAGS) 
	$(EX_TIMER_CC_SIZE) $(CYG_EX_TIMER_OUTPUT) 
	@echo ""

ex_timer_programclean:
	rm -f $(EX_TIMER_OUTPUT) 
