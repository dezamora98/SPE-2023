 ...
 *    \\vboxsvr\real-pc\Trabajo\CUJAE\SPE\SPE-2023\examples\ex_1\
 */
...
int main (void) {
...

   {
      ...
      print("\r\nRunning UartLiteSelfTestExample() for RS232_DTE...\r\n");
      status = UartLiteSelfTestExample(XPAR_RS232_DTE_DEVICE_ID);
      if (status == 0) {
